...
[목차](index.md) · [← 이전: 게임 상태](15-game-states.md) · [다음: 발사체 →](17-projectiles.md)
...
저장은 명시적인 데이터 구조를 대상으로 합니다. ECS 월드 전체에는 임시 데이터와 엔진 소유 데이터가 많이 들어 있으므로, 플레이어 진행도처럼 오래 유지할 값만 골라 저장합니다.
...
[← 이전: 게임 상태](15-game-states.md) · [목차](index.md) · [다음: 발사체 →](17-projectiles.md)
