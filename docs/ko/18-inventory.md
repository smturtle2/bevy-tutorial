...
[목차](index.md) · [← 이전: 발사체](17-projectiles.md) · [다음: 대화 →](19-dialogue.md)
...
![아이템을 수집하면 인벤토리 숫자가 바뀌는 장면](../../assets/screenshots/ch18-inventory.png)
...
```text
플레이 점수      RunStats.score는 이번 플레이의 가치를 계속 기록
인벤토리 리소스   Inventory는 플레이어가 가진 아이템을 기록
21장 씬 로딩     씬 파일이 InventoryItem 엔티티를 생성 가능
...
[← 이전: 발사체](17-projectiles.md) · [목차](index.md) · [다음: 대화 →](19-dialogue.md)
